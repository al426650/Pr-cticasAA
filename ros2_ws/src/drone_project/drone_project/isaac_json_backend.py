...
class IsaacJsonBackend(Node):
    def __init__(self):
        ...
        '''
        Creo que la solución optima es tratar la frecuencia como en una situación real,
        la sobrecarga de mi ordenador hace que la frecuencia a la que se publican los 
        topics baje, estaría bien que tuviera un búffer y que él actuara sobre el parámetro 
        de min frec del main loop del ardupilot.
        '''
